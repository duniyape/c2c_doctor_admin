...
const UpdateBrackup = () => {
  ...
  const [discount, setdiscount] = useState(patientdata.brackup.discount)

    const [testData, settestData] = useState(patientdata.brackup)
  ...
  headers: {
    ...
    console.log({...testData,discount},patientdata._id)
  try {
...
const [view, setView] = useState('billForm'); // Current view: 'add', 'list', or 'billForm'
    ...
    const [billCharges, setBillCharges] = useState([...patientdata.brackup.list]); // To store charges for the current bill
